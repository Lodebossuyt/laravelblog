...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="{{asset('img/imgfront/core-img/favicon.ico')}}">
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-12 col-md-4">
                    <div class="logo-area">
                        <a href="index.html"><img src="{{asset('img/imgfront/core-img/logo.png')}}" alt="logo"></a>
                    </div>
                </div>
                <!-- Header Advert Area -->
                <div class="col-12 col-md-8">
                    <div class="header-advert-area">
                        <a href="#"><img src="{{asset('img/imgfront/bg-img/top-advert.png')}}" alt="header-add"></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="collapse navbar-collapse" id="gazetteMenu">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    @foreach($categories as $category)
                                        <li class="nav-item">
                                            <a class="nav-link"
                                               href="{{route('home.category', $category)}}">{{$category->name}}</a>
                                        </li>
                                    @endforeach
                                </ul>
                                <!-- Search Form -->
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                ...
                <div class="comment_area section_padding_50 clearfix">
                    @if(Session::has('postcomments_message'))
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>
                                <i class="fa fa-check-circle"></i> Comment submitted!
                            </strong>
                    ...
                    <ol>
                        ...
                        @foreach($post->postcomments as $postcomment)
                            @if($postcomment->is_active)
                                <li class="single_comment_area">
                                    <div class="comment-wrapper d-md-flex align-items-start">
                                        <!-- Comment Meta -->
                                        <div class="comment-author">
                                            <img class="rounded-circle img-fluid"
                                                 src="{{$postcomment->user->photo ? asset($postcomment->user->photo->file) : 'http://via.placeholder.com/70x70'}}"
                                                 alt="">
                                        </div>
                                        <!-- Comment Content -->
                                        <div class="comment-content">
                                            ...
                                            <a class="reply-btn" data-toggle="collapse" href="#collapseExample{{$postcomment->id}}"
                                               role="button" aria-expanded="false" aria-controls="collapseExample{{$postcomment->id}}">Reply
                                                <i class="fa fa-reply" aria-hidden="true"></i></a>
                                            <div class="collapse" id="collapseExample{{$postcomment->id}}">
                                                @auth
                                                ...
                                                <ol class="children">
                                                    <li class="single_comment_area">
                                                        <div class="comment-wrapper d-md-flex align-items-start">
                                                            ...
                                                            <div class="comment-author">
                                                                <img
                                                                    src="{{$reply->user->photo ? asset($reply->user->photo->file) : 'http://via.placeholder.com/70x70'}}"
                                                                    alt="">
                                                            </div>
                                                            <!-- Comment Content -->
                                                            <div class="comment-content">
                                                                ...
                                                                <span
                                                                    class="comment-date text-muted">{{$reply->created_at->diffForHumans()}}</span>
                                                                <p>{{$reply->body}}</p>
                                                                <a class="reply-btn" href="#">Reply <i
                                                                        class="fa fa-reply"
...
<footer class="footer-area bg-img background-overlay"
        style="background-image: url({{asset('img/imgfront/bg-img/4.jpg')}});">
    <!-- Top Footer Area -->
