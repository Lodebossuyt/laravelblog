...
@section('content')
    <section class="single-post-area">
        <!-- Single Post Title -->
        <div class="single-post-title bg-img background-overlay" style="background-image: url({{asset('img/imgfront/bg-img/1.jpg')}});">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="single-post-thumb d-flex justify-content-center">
                            <img class="img-fluid" src="{{asset($post->photo ? $post->photo->file : 'http://via.placeholder.com/800x600')}}" alt="{{$post->title}}">
                        </div>
                    </div>
                    <div class="col-12 col-md-8">
                        <div class="single-post-text">
